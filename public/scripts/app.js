...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function handlePick() {
            ...
            this.setState(function () {
                return alert(_this2.state.options[Math.floor(Math.random() * _this2.state.options.length)]);
            });
        }
    }, {
        key: 'handleAddOption',
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('input', { type: 'text', name: 'option', placeholder: 'Enter Option Here' }),
                    React.createElement(
                        'button',
                        null,
                        'Add Option'
